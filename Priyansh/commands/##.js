...
✧ Bot Admin: Devil Sharabi
♛ Bot Admin Link: https://www.facebook.com/share/15WzCqCnCZ/
❂ Bot Prefix: ${global.config.PREFIX}
✫ Bot Owner: Devil Sharabi
➟ UPTIME
✬ Today is: ${juswa} 
...
`, attachment: fs.createReadStream(__dirname + "/owner_video.mp4")
 ...
 return request(encodeURI(link[Math.floor(Math.random() * link.length)]))
   .pipe(fs.createWriteStream(__dirname + "/owner_video.mp4"))
   .on("close", () => callback());
};
